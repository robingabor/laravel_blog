...
<div class="w-4/5 m-auto pt-20">
    ...
    <input type="text"
        name="title"
        class="bg-transparent outline-none block border-b-2 w-full h-20 text-6xl"
        value="{{ $post->title }}"
    >
    ...
    <button 
        type="submit" 
        class="upeprcase mt-15 bg-blue-500 text-gray-100 text-lg  font-extrabold py-4 px-8 rounded-3xl">
        Submit
    </button>
